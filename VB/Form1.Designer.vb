...
'			Me.defaultToolTipController1.DefaultController.GetActiveObjectInfo += New DevExpress.Utils.ToolTipControllerGetActiveObjectInfoEventHandler(Me.defaultToolTipController1_DefaultController_GetActiveObjectInfo);
			' 
			' Form1
			' 
